...
public class GeneticAlgorithm {
	...
	public void caculte(){
		...
		while(generation<maxIterNum){
			BaseLogger.INFO("-------------------------第 "+generation+" 代开始-------------------------");
			evolve();
			print();
			BaseLogger.INFO("-------------------------第 "+generation+" 代结束-------------------------");
			generation++;			
		}
		BaseLogger.INFO("===========================最终结果===========================");
	...
	private void print(){
//		INFO("-------------------------------------------------------------");  
		BaseLogger.INFO("the generation is:" + generation);
		BaseLogger.INFO("the best y is:" + bestFitness);
        BaseLogger.INFO("the worst fitness is:" + worstFitness);
        BaseLogger.INFO("the average fitness is:" + averageFitness);
        BaseLogger.INFO("the total fitness is:" + totalFitness);
        BaseLogger.INFO("geneI:" + geneI);
        BaseLogger.INFO("hBestTaskList:" + Arrays.toString(hBestTaskList));
        BaseLogger.INFO("hBestFitness:" + hBestFitness);
//      INFO("-------------------------------------------------------------");       
	}
	/**
	 * 初始化种群
